...
public class LogAspect {
    ...
    //Service层切点  
    @Pointcut("@annotation(com.lyp.aoplog.annotation.ServiceLog)")
    public void serviceAspect() {
    }

    //Controller层切点  
    @Pointcut("@annotation(com.lyp.aoplog.annotation.ControllerLog)")
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        try {
            ...
            log.setParams(null);
            log.setCreateBy(request.getParameter("user"));
        ...
        try {
            if (joinPoint.getArgs() != null && joinPoint.getArgs().length > 0) {
                for (int i = 0; i < joinPoint.getArgs().length; i++) {
                    params += new ObjectMapper().writeValueAsString(joinPoint.getArgs()[i]) + ";" ;
                }
            }
            /*========控制台输出=========*/
            ...
            System.out.println("请求人:" + request.getParameter("user"));
            System.out.println("请求IP:" + ip);
